...
public class BankAccountV2 {
    ...
    public BankAccountV2(String name, int ssn, Address address, DateOfBirth dob){
        this.name = name;
        this.ssn = ssn;
        this.address = address;
        this.dob = dob;
    }
    public BankAccountV2(String name, int ssn, Address address, DateOfBirth dob, int pin){
        this.name = name;
        this.ssn = ssn;
        this.address = address;
        this.dob = dob;
